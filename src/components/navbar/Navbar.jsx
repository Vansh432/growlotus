      ...
      <nav className="navbar">
        ...
        <div className={`navbar-links ${isMobileMenuOpen ? "active" : ""}`}>
          ...
          <div 
            ...
            onClick={()=> { toggleDropdown(); setBankServicesOpen(false); setOtherServicesOpen(false); }}
          >
          ...
          {isDropdownOpen && (
              <div id="menu" className={`dropdown-menu ${isMobileMenuOpen?"serviceAtMobile":""}`} onClick={()=>{ setBankServicesOpen(false); setOtherServicesOpen(false); } } >
                ...
                <NavLink to="" onMouseEnter={()=> { setBankServicesOpen(true); setOtherServicesOpen(false); } } >Bank & NBFC Services</NavLink>
                <NavLink to="" onMouseEnter={()=> { setOtherServicesOpen(true); setBankServicesOpen(false); } } >Other Services</NavLink>
            ...
            {isBankServicesOpen && (
              <div id="menu" className={`bank-dropdown-menu ${isMobileMenuOpen?"serviceAtMobile":""}`} onMouseLeave={()=> toggleBankServices() }>
                <NavLink to='' onClick={toggleBankServices} >Personal Loan</NavLink>
                <NavLink to='' onClick={toggleBankServices} >Credit Card</NavLink>
                <NavLink to='' onClick={toggleBankServices} >Business Loan</NavLink>
                <NavLink to='' onClick={toggleBankServices} >CC/OD/DOD</NavLink>
              </div>
            )}
